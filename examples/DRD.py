...
from examples.setup import SubDataset, AbstractDomainInterface, ExpandRGBChannels
import os
...
import numpy as np
# from .data_utils import RandAugment
...
class DRD(AbstractDomainInterface):
    ...
    def __init__(self, transform, root_path="/mnt/disk2/mjlee/MedOOD/data/DRD/", downsample=None, shrink_channels=False, test_length=None, download=False,
                 extract=True, doubledownsample=None, leave_out_classes=(), keep_in_classes=None, n=3, m=20):
        """
